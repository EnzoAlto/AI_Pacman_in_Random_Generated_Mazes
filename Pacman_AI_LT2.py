...
REFLEX_WEIGHTS = {
    ...
    "scared_ghost_gain": 3.0,   # 1 / (1 + min_scared_ghost_dist)
    "step_cost": 0.0,           # small negative per move if you want
    "reverse_penalty":10000
}
...
def reflex_evaluation(grid, pac_tile, action, ghosts, weights): # Scores which legal action is best 
    """Higher is better."""
    (pr, pc) = pac_tile
    (dx, dy) = action
